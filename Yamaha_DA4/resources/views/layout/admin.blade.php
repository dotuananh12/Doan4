...
<body class="hold-transition skin-blue fixed sidebar-mini">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="{{url('/dangxuat')}}" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{("sanpham")}}"><i class="fa fa-circle-o"></i> Quản lý sản phẩm</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Loại sản phẩm</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{("loaixe")}}"><i class="fa fa-circle-o"></i>Loại xe</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{("khachhang")}}"><i class="fa fa-circle-o"></i>khachhang</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{("donhang")}}"><i class="fa fa-circle-o"></i> Quản lý đơn hàng</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{("tintuc")}}"><i class="fa fa-circle-o"></i> Quản lý tin tức</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{("lienhe")}}"><i class="fa fa-circle-o"></i> Quản lý đơn hàng</a></li>
  ...
  <script src="{{url('public/admin')}}/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
  <script>
    $(function() {
      $('#example1').DataTable();
      $('#example2').DataTable({
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{url('public/admin')}}/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
